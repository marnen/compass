...
Gem::Specification.new do |s|
  ...
  s.authors = ["Marnen Laibow-Koser", "Chris Eppstein"]
  s.date = %q{2009-10-12}
  s.default_executable = %q{compass}
  s.description = %q{Compass is a Sass-based Stylesheet Framework that streamlines the creation and maintainance of CSS. This is Marnen Laibow-Koser's fork.}
